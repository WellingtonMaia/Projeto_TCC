                        ...
                        <div class="white-box">
                            ...
                            <div class="comment-center p-t-10">
                                <div class="comment-body">
                                    <div class="user-img"> <img src="{{ asset('css/plugins/images/users/pawandeep.jpg')}}" alt="user" class="img-circle">
                                    </div>
                                ...
                                <div class="comment-body">
                                    <div class="user-img"> <img src="{{ asset('css/plugins/images/users/sonu.jpg')}}" alt="user" class="img-circle">
                                    </div>
                                    <div class="mail-contnet">
                                ...
                                <div class="comment-body b-none">
                                    <div class="user-img"> <img src="{{ asset('css/plugins/images/users/arijit.jpg')}}" alt="user" class="img-circle">
                                    </div>
                                    <div class="mail-contnet">
                                    ...
                                    <div class="panel-body">
                                        <ul class="chatonline">
                                            <li>
                                                ...
                                                <a href="javascript:void(0)"><img src="{{ asset('css/plugins/images/users/varun.jpg')}}" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                            </li>
                                            <li>
                                                <div class="call-chat">
                                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
                                                ...
                                                <a href="javascript:void(0)"><img src="{{ asset('css/plugins/images/users/genu.jpg')}}" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                            </li>
                                            <li>
                                                <div class="call-chat">
                                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
                                                ...
                                                <a href="javascript:void(0)"><img src="{{ asset('css/plugins/images/users/ritesh.jpg')}}" alt="user-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                                            </li>
                                            <li>
                                                <div class="call-chat">
                                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
                                                ...
                                                <a href="javascript:void(0)"><img src="{{ asset('css/plugins/images/users/arijit.jpg')}}" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                                            </li>
                                            <li>
                                                <div class="call-chat">
                                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
                                                ...
                                                <a href="javascript:void(0)"><img src="{{ asset('css/plugins/images/users/govinda.jpg')}}" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a>
                                            </li>
                                            <li>
                                                <div class="call-chat">
                                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
                                                ...
                                                <a href="javascript:void(0)"><img src="{{ asset('css/plugins/images/users/hritik.jpg')}}" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                                            </li>
                                            <li>
                                                <div class="call-chat">
                                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
